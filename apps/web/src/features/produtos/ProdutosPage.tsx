          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50 text-left text-[11.5px] font-bold uppercase tracking-wide text-slate-500">
                ...
                <th className="px-3 py-[11px]">Apelido (nome curto)</th>
                <th className="px-3 py-[11px]">Nome completo</th>
                <th className="hidden px-3 py-[11px] text-right md:table-cell">Peso unit.</th>
              ...
              {linhas.map((p) => (
                <tr key={p.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-3 py-2.5 text-right">
                    <button onClick={() => setEditando(p)} className="text-xs font-medium text-slate-500 hover:text-brand-600">Editar</button>
                  </td>
                </tr>
              ))}
            </tbody>
