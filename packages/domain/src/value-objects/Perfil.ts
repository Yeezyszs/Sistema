...
export const MODULO = [
  ...
  'qualidade', 'acompanhamento', 'monitoramento_agua', 'pcc_fisico', 'ppho', 'especificacoes', 'calibracao',
...
export const MODULOS_POR_PERFIL: Record<Perfil, Modulo[]> = {
  ...
  qualidade: [
    'lotes', 'recebimentos', 'fornecedores', 'qualidade', 'acompanhamento', 'monitoramento_agua', 'pcc_fisico', 'ppho',
