          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50 text-left text-[11.5px] font-bold uppercase tracking-wide text-slate-500">
                <th className="px-3 py-[11px]">Trim.</th>
                <th className="px-3 py-[11px]">Equipamento</th>
                <th className="px-3 py-[11px]">Componente</th>
                <th className="px-3 py-[11px]">Planejada</th>
                <th className="px-3 py-[11px]">Realizada</th>
                <th className="hidden px-3 py-[11px] md:table-cell">Executores</th>
